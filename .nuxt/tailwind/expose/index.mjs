...
const config = { theme, corePlugins, plugins, darkMode, content, prefix, presets, important, separator, safelist, blocklist }
export { config as default, theme, corePlugins, plugins, darkMode, content, prefix, presets, important, separator, safelist, blocklist }